...
export interface OutOptions {
    /**
     * The path where the exported collections will be saved.
     *
     * Default: './exported'
     */
    outDir?: string;
     ...
     * exported collections of that database with the collection name as folder name
     * 'flat': No folder will be created for each database. A folder whose name is the
